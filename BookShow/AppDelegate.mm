...
//  Copyright Lion 2014年. All rights reserved.
//
...
-(void) directorDidReshapeProjection:(CCDirector*)director
{
	if(director.runningScene == nil) {
		...
		[director runWithScene: [CCBReader sceneWithNodeGraphFromFile:@"StartScene.ccbi"]];
//        [director runWithScene:[MultiLayerScene scene]];
	}
}
@end
